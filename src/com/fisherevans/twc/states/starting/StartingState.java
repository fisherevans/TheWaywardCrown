...
public class StartingState extends State
{
	...
	public void render(GameContainer gc, Graphics gfx) throws SlickException
	{
		...
		gfx.setFont(ResourceTools.fontFP64());
		gfx.drawString(TITLE, GameDriver.NATIVE_SCREEN_WIDTH/2 - ResourceTools.fontFP64().getWidth(TITLE)/2, GameDriver.NATIVE_SCREEN_HEIGHT*0.2f);
